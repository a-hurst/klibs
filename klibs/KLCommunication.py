...
import klibs.text_manager as tm  # note: this is a global instance of TextManager, not the class itself; see __init__.py
from klibs.KLConstants import *
import klibs.KLParams as P
from klibs.KLUtilities import absolute_position, now, pretty_join, sdl_key_code_to_str
...
def alert(text, blit=True, display_for=0):
		...
		self.clear()
		self.fill(P.default_fill_color)
