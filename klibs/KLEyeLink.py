...
#				print "FixationEvent | avgGze:{2}, avgX: {3}, avgY: {4}, startTime: {0}, endTime:{1}".format(*p_v)
	...
	from klibs.KLGraphics.KLNumpySurface import *  # a class for easily moving between numpy pixel arrays and sdl2/openGL
	import array
	import sys
	...
	class ELCustomDisplay(pylink.EyeLinkCustomDisplay):
		...
		def alert_printf(self, message):
			self.experiment.message(message, color=(255, 0, 0, 0),
									location=(0.05 * Params.screen_x, 0.05 * Params.screen_y))
