...
from sdl2 import (SDL_Event, SDL_PumpEvents, SDL_PushEvent, SDL_FlushEvents, SDL_RegisterEvents,
	SDL_GetError, SDL_FIRSTEVENT, SDL_LASTEVENT, SDL_DISABLE, SDL_ENABLE, SDL_BUTTON,
	SDL_BUTTON_LEFT, SDL_BUTTON_RIGHT, SDL_BUTTON_MIDDLE, KMOD_LSHIFT, KMOD_RSHIFT, KMOD_CAPS)
