...
# NOTE: missing tests for any_key, mouse_pos, konami_code, and show/hide cursor
...
class TestKLUserInterface(object):

    @classmethod
    def setup_class(cls):
        if sdl2.SDL_Init(sdl2.SDL_INIT_VIDEO) != 0:
            raise pytest.skip('Unable to initialize video subsystem')
